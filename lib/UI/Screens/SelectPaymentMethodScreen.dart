...
class SelectPaymentMethodSceen extends StatefulWidget {
  const SelectPaymentMethodSceen({Key? key, required this.total}) : super(key: key);
  final int total;
                ...
                Row(
                  children: [
                    Text("Total",style: TextStyle(fontWeight: FontWeight.w600,color: Color.fromRGBO(51, 51, 51, 1),fontSize: 11),),
                     SizedBox(width: 5,),
                    Text("${widget.total} DA",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.black,fontSize: 14),),
                          ...
                          Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                      padding: EdgeInsets.symmetric(vertical: 10), backgroundColor: Colors.grey,
                                      shape: RoundedRectangleBorder(
