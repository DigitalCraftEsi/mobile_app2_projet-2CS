...
class AcceptPaymentScreen extends StatefulWidget {
  const AcceptPaymentScreen({Key? key, required this.total}) : super(key: key);
  final int total;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text("${widget.total} DA",style: TextStyle(fontWeight: FontWeight.w700,color: Colors.black,fontSize: 27),),
                    ],
                  ),
                ),
              ),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            Navigator.of(context).pushReplacement(MaterialPageRoute(
                                ...
                                builder: (BuildContext context) => SelectPaymentMethodSceen(total: widget.total,)));
                          },
                        ),
                      ),
                    ),
